...
try {
  ...
  await page.screenshot({ path: path.join(artifacts, "public_enex_preview_v4.png"), fullPage: true });
  ...
  await page.screenshot({ path: path.join(artifacts, "public_enex_reloaded_v4.png"), fullPage: true });
