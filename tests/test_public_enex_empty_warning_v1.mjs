...
const appFile = process.env.NOTEPLUS_APP_FILE || "%EB%85%B8%ED%8A%B8%EC%95%B1_v7.html";
...
try {
  ...
  await page.screenshot({ path: path.join(artifacts, "public_enex_empty_warning_v1.png"), fullPage: true });
  ...
  await page.screenshot({ path: path.join(artifacts, "public_enex_zero_notes_warning_v1.png"), fullPage: true });
