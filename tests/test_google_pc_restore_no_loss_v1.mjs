...
try {
  ...
  const fixture = await page.evaluate(async ({localBase64, cloudBase64, cloudSha}) => {
    ...
    const manifest = {format: "noteplusp-cloud-snapshot-v1", schema: 5, appVersion: "v14", snapshotId, createdAt: new Date().toISOString(), counts: {noteCount: 1, activeNoteCount: 1, trashNoteCount: 0, attachmentCount: 1}, state: cloudState, attachments: [descriptor]};
